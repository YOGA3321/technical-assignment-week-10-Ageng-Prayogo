...
TOKEN = "BBFF-d1RJ4VTGj2RcJGWHxFx4FdDrfcK5sj"  # Put your TOKEN here
...
VARIABLE_LABEL_4 = "jarak-1"  # Put your second variable label here


def build_payload(variable_1, variable_2, variable_3, variable_4):
    # Creates two random values for sending data
    value_1 = random.randint(20, 100)
    value_2 = random.randint(20, 100)
    value_3 = random.randint(20, 100)
